...
Adjective Expressions: [
  [Word(relatively), Word(), Variable, Word(prime, primes)],
  [Word(divided), Word(by), Variable],
  [Word(nonzero)],
...
Right Predicate Expressions: [
  [Symbol(=), Variable, Symbol((), Symbol(mod), Variable, Symbol())]
]
